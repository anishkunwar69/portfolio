...
function HeroContent() {
  const words = useMemo(() => ["7 days", "2 weeks", "record time", "with confidence"], []);
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 w-1/2 h-full bg-gray-50 z-0"
      ></div>
      <div
      ...
      <Container className="flex-1 flex flex-col justify-center z-10 py-16 xl:py-12">
        ...
        <div className="hero-container flex flex-col gap-8 md:gap-12 items-center relative">
          <div className="hero-content relative w-full text-center">
            <div
              className="left-bar hidden absolute -left-4 top-0 w-1 h-24 bg-blue-500"
            ></div>
            <h2
              className="text-sm uppercase tracking-wider text-blue-600 mb-1 font-medium"
            >
              Web Development Agency
            </h2>
            <h1
              className="text-3xl md:text-5xl lg:text-5xl 2xl:text-6xl font-serif mb-3 leading-tight"
            >
              We build <span className="font-medium">high-converting</span> Websites & MVPs
            </h1>

            <div
              className="h-10 mb-2 md:mb-3 md:h-12 2xl:h-14"
            >
            ...
            <p
              className="hero-paragraph text-gray-700 max-w-lg mx-auto my-0 max-sm:text-sm"
            >
              We help founders & creators launch fast, sell better, and grow online — with 
              high-converting websites and MVPs, built in weeks, not months. From idea to 
              live product that drives real business results.
            </p>

            <div
              className="button-group flex flex-wrap justify-center gap-4 md:gap-6 mt-6"
            >
              <Link
              ...
              >
                ...
                <span className="relative text-white">Book a Free Discovery Call</span>
              </Link>
              ...
              >
                ...
                <span className="relative text-gray-800">See How We Help Founders</span>
              </Link>
            </div>
            
            <div className="mt-8 text-sm text-gray-500 max-sm:text-xs">
              <p>Limited slots available for Q3 2023 — Book now to secure your project</p>
            </div>
          </div>
      ...
      <div
        className="w-full flex flex-col sm:flex-row justify-between items-center py-6 px-4 sm:px-8 md:px-12 z-10 border-t-[1px] border-slate-200 gap-4"
      >
