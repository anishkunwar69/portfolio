...
From idea to launch, we turn your vision into a live product that drives real business results — fast.
        ...
        <div className="md:col-span-7">
          ...
          <div className="mt-8">
            <Link href="https://www.instagram.com/anishkunwar_21/" className="inline-flex items-center group">
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              ...
              {/* Reddit */}
              <Link
                href="https://www.reddit.com/user/anish_k2699/"
                target="_blank"
                rel="noopener noreferrer"
                className="group relative"
              >
                <div className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 flex items-center justify-center transition-all duration-300 group-hover:bg-white/20 group-hover:border-white/40 group-hover:-translate-y-1">
                  <svg
                    className="w-5 h-5 text-white transition-colors duration-300 group-hover:text-orange-200"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
